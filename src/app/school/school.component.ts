...
export class SchoolComponent implements OnInit {
  ...
  obj:any=[];
 paramId:any;
  constructor(private fb: FormBuilder ,private service:StudentService,private route:Router,private router:ActivatedRoute) { }
  ...
  onSubmit(){
    ...
    if (this.paramId) {
      ...
      this.service.editstudent(this.schoolForm.value, this.paramId) .subscribe((res) => {
          console.log(res);
